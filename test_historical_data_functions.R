...
get_factors_responses_target <- function(d0) 
{
  ...
  dfactor12 <- d0 %>% 
    ...
    dplyr::summarize(store_primary_category_target_WH=mean(Target))
  ...
  return(list(dfactor1=dfactor1,dfactor11=dfactor11, dfactor12=dfactor12,  
